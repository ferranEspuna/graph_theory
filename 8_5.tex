...
\begin{document}
    ...
    \begin{proposition} \label{prop:a}
        ...
        \begin{proof}
            ...
            At each step of the path, the height (distance from the root) either increases by $1$ (we say we go \emph{down})
            or decreases by $1$ (we say we go \emph{up}). Because both at the start and end of the path the height must be in the range $[0, k]$, the difference
            betwen the number of \emph{up} steps $s_{u}$ and the number of \emph{down} steps $s_{d}$ must satisfy
            ...
            All together,
            \begin{equation*}
                \frac{p}{2} - k \leq s_d \leq  \frac{p}{2} + k
            \end{equation*}
            ...
            \begin{equation*}
                P_{i,p}
                \leq
                \sum_{s_d = \frac{p}{2} - k}^{\frac{p}{2} + k} \binom{p}{s_d} (d-1)^{s_d}
                \leq
                2 \cdot k \cdot 2^p \cdot (d-1)^{\frac{p}{2}}
            \end{equation*}

            Putting this together with~\eqref{eq:norm_bound}, we get
            \begin{equation*}
                \norm{A}_2^p \leq 2 \cdot k \cdot 2^p \cdot (d-1)^{\frac{p}{2}}
                \implies
                \norm{A}_2 \leq \lim_{p \to \infty}  \left( 2 \cdot k \cdot 2^p \cdot (d-1)^{\frac{p}{2}}\right)^{\frac{1}{p}} = 2 \sqrt{d-1}
            \end{equation*}
        \end{proof}
    \end{proposition}
    ...
    \begin{proposition}
        ...
        \begin{proof}
            ...
            Because of the maximum in the formula in the $\infty$-norm, we're free to choose the startring vertex $v_i$.
            ...
            \begin{equation*}
                \norm{A(k)}_2 \geq \lim_{k \to \infty} \left( \frac{4^k}{(k+1)2\sqrt{kn}} (d-1)^k \right)^{\frac{1}{2k}} = 2 \sqrt{d-1}
            \end{equation*}
